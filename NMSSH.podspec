Pod::Spec.new do |spec|
  ...
  spec.license      = 'MIT'
  spec.authors      = { "Christoffer Lejdborg" => "hello@9muses.se", "Tommaso Madonia" => "tommaso@madonia.me", "Stephen Oliver" => "steve@infincia.com" }

  spec.source       = { :git => "https://github.com/infincia/NMSSH.git", :tag => spec.version.to_s }
